...
public class PlayerGizmos : MonoBehaviour{
    private void OnDrawGizmos() {
        ...
        Vector3 spherePosition2 = new Vector3(transform.position.x + 0.616f * transform.TransformDirection(Vector3.forward).x, transform.position.y + 0.1f, 
        ...
        Vector3 spherePosition3 = new Vector3(transform.position.x + 2f * transform.TransformDirection(Vector3.forward).x, transform.position.y + 0.1f, 
